...
import { selectMediatorUser, selectPaymentCards } from '../../../../redux/reducers/Reducers';
import { useSelector } from 'react-redux';
import Loader from '../../components/Loader';
import Wallet from '../../../assets/Wallet.svg';
import Balance from '../../../assets/balance.svg';
import Deposit from '../../../assets/deposit.svg';
import SVGDel from '../../../assets/delete.svg';
import { TextInput } from 'react-native-paper';
import PaymentTypes from '../../components/PaymentTypes';
import SVGImg2 from '../../../assets/arrowleft.svg';
...
const MediatorAccountScreen = ({ navigation }) => {
    ...
    const OnAddCard = () => {
        navigation.navigate('MediatorPaymentOptionScreen')
    }
                        ...
                        <View>
                            ...
                            {PaymentCards ?
                                ...
                                <View style={{
                                    ...
                                    <SVGDel width={width / 6} height={width / 6} />
                                    <View style={{
                                        paddingVertical: 50,
                                    }}>
                                        <Text>
                                            Your payment method is not attached. Please add a payment method first, and then check your balance.
                                        </Text>
                                    </View>
                                    <View >
                                        <CustomeButton title={'Add Card'} onpress={() => OnAddCard()} />
                                    </View>
                                </View>
                            }
                        </View>
...
export default MediatorAccountScreen
