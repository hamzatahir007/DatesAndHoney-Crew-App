import { Image, SafeAreaView, StatusBar, StyleSheet, Text, View, ToastAndroid, Alert, Dimensions } from 'react-native'
...
const MediatorQuestionBioScreen = ({ navigation, route }) => {
  ...
  const handleBioChange = (text) => {
    if (text.length <= 200) {
      ...
      ToastAndroid.show("Character Limit Exceeded', 'Maximum character limit is 200.", ToastAndroid.SHORT);
    }
  };
