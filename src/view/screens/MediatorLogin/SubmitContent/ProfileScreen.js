...
const ProfileScreen = ({ navigation }) => {
    ...
    const OnSaveChanges = async () => {
        if (name == null || name == '' || email == null || email == '' || !email === EMAIL_REGEX.test(email) || location == null || location == '' || number == null || number == '' || about == null || about == '') {
            if (name == null || name == '') {
                ToastAndroid.show('Please enter new username!', ToastAndroid.SHORT)
                setNameError(true)
            }
            ...
            <View style={styles.container}>
                ...
                <ScrollView vertical showsVerticalScrollIndicator={false}>
                    <View style={{
                        ...
                        {name != mediator?.userDetails?.Name || email != mediator?.userDetails?.email || location != mediator?.userDetails?.Address || number != mediator?.userDetails?.Phonenumber || about != mediator?.userDetails?.Bio ?
                            <View style={{
                                alignSelf:'center',
                                marginTop: 40,
                            }}>
