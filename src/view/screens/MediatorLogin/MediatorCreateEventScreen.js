...
const MediatorCreateEventScreen = ({ navigation }) => {
    ...
    const [totalTicketPrice, setTotalTicketPrice] = useState(null);
    ...
    const [discountPerTicket, setDiscountPerTicket] = useState(null);
            ...
            if (discountPerTicket) {
                if (!discountStartDate) {
                    ...
                    if (TicketModaldata?.find(element => element.index == ticketIndex)) {
                        ...
                        console.log('updatedArray', TicketModaldata);
