                ...
                <View style={{
                    ...
                    <View>
                        <View style={{
                            ...
                            <Text style={{ fontSize: 12, marginRight: 3 }}>Event Name</Text>
                        </View>
                        <View style={{
                            flexDirection: 'row',
                            alignItems: 'center'
                        }}>
                            <Text style={{ color: COLORS.black }}>New party at Los Angeles</Text>
                        </View>
                    </View>
                    {/* <View>
                        <View style={{
                    ...
                    <TouchableOpacity
                        ...
                        <View style={{ flexDirection: 'row', }}>
                            ...
                            <Text style={{ fontSize: 11, lineHeight: 18, color: '#000' }}>1</Text>
                        </View>
                    </TouchableOpacity>
                </View>
