        ...
        <View style={{
            ...
            <View style={{
                ...
                <View
                    ...
                    style={{
                        borderWidth: props?.userdata?.PartnerGender == 'Male' ? 1 : 0,
                        borderColor: props?.userdata?.PartnerGender == 'Male' ? '#2A3182' : COLORS.transparent,
                        borderRadius: 10,
                        // paddingHorizontal: 20,
                        paddingVertical: 10,
                        width: '33%'
                    ...
                    <Text style={{
                        textAlign: 'center',
                        color: props?.userdata?.PartnerGender == 'Male' ? '#2A3182' : COLORS.gray,
                    }}>
                        {props?.userdata?.PartnerGender == 'Male' ? 'Boys' : 'Boys'}
                    </Text>
                </View>
                <View
                    // key={index}
                    // onPress={() => setSelectGender(index)}
                    style={{
                        borderWidth: props?.userdata?.PartnerGender == 'Female' ? 1 : 0,
                        borderColor: props?.userdata?.PartnerGender == 'Female' ? '#2A3182' : COLORS.transparent,
                        borderRadius: 10,
                        // paddingHorizontal: 20,
                        paddingVertical: 10,
                        width: '33%'
                    ...
                    <Text style={{
                        textAlign: 'center',
                        color: props?.userdata?.PartnerGender == 'Female' ? '#2A3182' : COLORS.gray,
                    }}>
                        {props?.userdata?.PartnerGender == 'Female' ? 'Girls' : 'Girls'}
                    </Text>
                </View>
                <View
                    // key={index}
                    // onPress={() => setSelectGender(index)}
                    style={{
                        borderWidth: props?.userdata?.PartnerGender == 'Both' ? 1 : 0,
                        borderColor: props?.userdata?.PartnerGender == 'Both' ? '#2A3182' : COLORS.gray,
                        borderRadius: 10,
                        // paddingHorizontal: 20,
                        paddingVertical: 10,
                        width: '33%'
                    ...
                    <Text style={{
                        textAlign: 'center',
                        color: props?.userdata?.PartnerGender == 'Both' ? '#2A3182' : COLORS.gray,
                    }}>
                        Both
                    </Text>
                </View>
            ...
            <View style={{
                ...
                <Text style={{
                    ...
                    Distance {props?.userdata?.distance && props?.userdata?.distance} miles
                </Text>
                <Text style={{
                    color: COLORS.black,
                    fontSize: 15,
            ...
            <View style={{
                ...
                <View style={{
                    width: `${parseInt(props?.userdata?.distance) + 0}%`,
                    height: 2,
                    backgroundColor: COLORS.main,
                }}>
                </View>
