import { Dimensions, Image, Modal, ScrollView, StyleSheet, Text, TouchableOpacity, View, ToastAndroid } from 'react-native'
...
const UserDetails = ({ onChat, onpress, onpressAccept,onpressReject, type, data, setData, modal, setModal }) => {
    ...
    const OnSendMessages = (props) => {
        // if (type == 'Client Details') {
        //     onChat
        //     setModal(false)
        //     setData(null)
        // }
        // else {
        // }
        ToastAndroid.show(`You cannot message ${props?.Name} until you accept their request.`, ToastAndroid.SHORT);
        // console.log('You cannot message this user until I accept their request.' , props.Name);
    }
                                ...
                                <View>
                                    <View style={{
                                        ...
                                        <View style={{
                                            ...
                                            <TouchableOpacity onPress={type=='Client Details' ? onChat : () => OnSendMessages(data)}>
