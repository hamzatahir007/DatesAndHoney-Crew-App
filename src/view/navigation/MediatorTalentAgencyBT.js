...
const ProfileStack = ({ navigation }) => (
    <Tab.Navigator screenOptions={{
        ...
        <Tab.Screen name="StockContent" component={StockContent} options={{
                unmountOnBlur: true
            }} />
        <Tab.Screen name="StockVideo" component={StockVideo} options={{
                unmountOnBlur: true
            }} />
        <Tab.Screen name="StockImage" component={StockImage} options={{
                unmountOnBlur: true
            }} />
    </Tab.Navigator>
)
